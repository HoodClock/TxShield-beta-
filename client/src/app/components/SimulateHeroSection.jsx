    ...
    <section className="relative h-full min-h-screen w-full bg-background overflow-hidden flex flex-col justify-center items-center transition-colors duration-700">
      ...
      >
        ...
        <div className="text-center w-full mb-12 relative cursor-default select-none">
          ...
          >
            <div className="flex items-center gap-4 text-xs sm:text-sm md:text-base font-mono tracking-[0.3em] uppercase text-muted-foreground">
              <span className="w-8 md:w-16 h-px bg-gradient-to-r from-transparent to-border"></span>
            ...
            <p className="text-muted-foreground font-mono text-[10px] md:text-xs tracking-widest uppercase mt-4 max-w-xl text-center leading-relaxed">
        ...
        <div className="mt-12 md:mt-20 flex flex-col sm:flex-row gap-6 md:gap-10 items-center justify-center w-full">
          ...
          <m.button
            ...
            whileHover={{ y: -5 }}
            whileTap={{ scale: 0.98 }}
            className="group relative w-64 md:w-80 h-20 md:h-24 overflow-hidden bg-card border border-border hover:border-cyan-500/50 rounded-none transition-all duration-500 flex items-center px-6"
          >
            ...
            <div className="relative z-10 flex items-center justify-between w-full">
              <div className="flex items-center gap-4">
                <SiEthereum className="text-2xl md:text-3xl text-muted-foreground group-hover:text-cyan-400 transition-colors duration-300" />
                <div className="flex flex-col items-start">
                  <span className="text-lg md:text-xl font-light tracking-widest text-foreground group-hover:text-primary transition-colors duration-300 uppercase">EVM</span>
                  <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-muted-foreground group-hover:text-cyan-500/80 transition-colors duration-300">Ethereum Network</span>
                </div>
              </div>
              <span className="text-muted-foreground group-hover:text-cyan-400 group-hover:translate-x-2 transition-all duration-300 font-mono">→</span>
            </div>
          </m.button>
          ...
          <m.button
            ...
            whileHover={{ y: -5 }}
            whileTap={{ scale: 0.98 }}
            className="group relative w-64 md:w-80 h-20 md:h-24 overflow-hidden bg-card border border-border hover:border-purple-500/50 rounded-none transition-all duration-500 flex items-center px-6"
          >
            ...
            <div className="relative z-10 flex items-center justify-between w-full">
              <div className="flex items-center gap-4">
                <SiSolana className="text-2xl md:text-3xl text-muted-foreground group-hover:text-purple-400 transition-colors duration-300" />
                <div className="flex flex-col items-start">
                  <span className="text-lg md:text-xl font-light tracking-widest text-foreground group-hover:text-primary transition-colors duration-300 uppercase">SOL</span>
                  <span className="text-[10px] font-mono uppercase tracking-[0.2em] text-muted-foreground group-hover:text-purple-500/80 transition-colors duration-300">Solana Network</span>
                </div>
              </div>
              <span className="text-muted-foreground group-hover:text-purple-400 group-hover:translate-x-2 transition-all duration-300 font-mono">→</span>
            </div>
          </m.button>
        </div>
      </m.div>
