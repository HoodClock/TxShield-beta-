...
const testimonials = [
    { name: "Ravi Sankar", role: "Web 3 Developer", content: "Just checked out TxShield — really cool stuff! I can totally see how something like this can help people feel safer when interacting with Web3 apps. The interface is clean, and I love that it's straight to the point.", image: "/Images/ravisankar.jpeg", linkedin: "https://www.linkedin.com/in/ravi-sankar13/", initials: "RS" },
    { name: "Sarah Chen", role: "DeFi Researcher", content: "The honeypot detection feature is a lifesaver. I analyze dozens of tokens daily, and TxShield gives me that extra layer of confidence before I recommend anything to my community. Essential tool.", image: null, linkedin: "#", initials: "SC" },
    { name: "Alex Thompson", role: "NFT Collector", content: "I've lost funds to phishing links before, so the simulation feature is exactly what I needed. Seeing exactly what a transaction will do before I sign it changes everything.", image: null, linkedin: "#", initials: "AT" },
    { name: "Elena Rostova", role: "Smart Contract Auditor", content: "Impressive static analysis speed. The way it catches obscure reentrancy patterns before transaction broadcasting is on par with enterprise-grade tools. Very well executed.", image: null, linkedin: "#", initials: "ER" },
    { name: "Marcus Webb", role: "DEX Trader", content: "Slippage protection and sandbox simulations have saved me from multiple front-running bots this week alone. This extension is now mandatory for my entire trading team.", image: null, linkedin: "#", initials: "MW" },
    { name: "David Kim", role: "Web3 Agency Lead", content: "We strictly advise our high-net-worth clients to install TxShield. The visual pipeline makes it easy for non-technical users to understand exactly what they are approving.", image: null, linkedin: "#", initials: "DK" },
    { name: "Jessica Lin", role: "Yield Farmer", content: "Finally, a security tool that doesn't scream 'WARNING' at everything. It accurately flags the real threats. The UI is absolutely stunning, feels like a premium SaaS dashboard.", image: null, linkedin: "#", initials: "JL" },
    { name: "Omar Farooq", role: "Protocol Engineer", content: " Integrating with TxShield's API for our custom wallet was seamless. The threat intelligence feed is top-notch and constantly updated. Highly recommended.", image: null, linkedin: "#", initials: "OF" }
];
    ...
    return (
        <section className="relative py-20 bg-black overflow-hidden flex flex-col justify-center min-h-[700px]">
            ...
            <style jsx global>{`
                ...
                .scroll-right {
                    animation: scroll-right calc(var(--marquee-duration) * 1.2) linear infinite;
                }
            ...
            <div className="relative z-10 w-full max-w-[100vw] overflow-hidden">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-white/5 border border-white/10 mb-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.1)]">
                        ...
                        <span className="text-xs text-gray-300 font-semibold tracking-wider uppercase">Live Intel</span>
                    </div>
                    ...
                    <p className="text-gray-400 text-sm sm:text-base max-w-2xl mx-auto font-light">
                        Real-time reviews from developers, analysts, and traders utilizing TxShield.
                    </p>
                </m.div>
    ...
    <div className="relative group w-[350px] sm:w-[400px] shrink-0">
        ...
        <div className="relative h-full bg-[#0c0c0c]/80 backdrop-blur-xl rounded-2xl p-6 border border-white/10 flex flex-col justify-between shadow-[inset_0_1px_0_rgba(255,255,255,0.05)] cursor-pointer hover:-translate-y-1 transition-transform duration-300 group-hover:border-white/20">
            ...
            <div className="flex justify-between items-start mb-4">
                <svg className="w-8 h-8 text-blue-500/40 group-hover:text-blue-500/80 transition-colors" fill="currentColor" viewBox="0 0 32 32">
                    <path d="M9.352 4C4.456 7.456 1 13.12 1 19.36c0 5.088 3.072 8.064 6.624 8.064 3.36 0 5.856-2.688 5.856-5.856 0-3.168-2.208-5.472-5.088-5.472-.576 0-1.344.096-1.536.192.48-3.264 3.552-7.104 6.624-9.024L9.352 4zm16.512 0c-4.8 3.456-8.256 9.12-8.256 15.36 0 5.088 3.072 8.064 6.624 8.064 3.264 0 5.856-2.688 5.856-5.856 0-3.168-2.304-5.472-5.184-5.472-.576 0-1.248.096-1.44.192.48-3.264 3.456-7.104 6.528-9.024L25.864 4z" />
                </svg>
                {/* 5-Star Rating Simulation */}
                <div className="flex gap-1">
                    {[1, 2, 3, 4, 5].map(star => (
                        <svg key={star} className="w-3.5 h-3.5 text-purple-500 animate-[pulse_2s_ease-in-out_infinite]" style={{ animationDelay: `${star * 0.1}s` }} fill="currentColor" viewBox="0 0 20 20">
