...
function HeroSection() {
  return (
    <section
      ...
      style={{ border: "none", borderTop: "none", marginTop: 0, paddingTop: 0 }}
    >
      ...
      >
        ...
        >
          ...
          >
            <div
              className="absolute inset-0 bg-cyan-500/10 rounded-full opacity-50 max-sm:hidden"
        ...
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-7xl font-bold mb-4 sm:mb-6 tracking-tight px-2 flex flex-col items-center gap-1 sm:gap-2">
          <span className="grad-word leading-tight py-2">SHIELD</span>
        ...
        <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4">
          ...
          >
            ...
            <div
              className="hidden sm:block absolute inset-0 rounded-lg bg-gradient-to-r from-purple-500/50 via-cyan-500/50 to-purple-500/50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10"
