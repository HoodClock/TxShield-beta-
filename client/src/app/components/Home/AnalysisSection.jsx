...
function AnalysisSection() {
    ...
    const getThemeClasses = (id, isSelected) => {
        if (id === 'honeypot') {
            return {
                border: isSelected ? 'border-cyan-500/50' : 'border-white/10 hover:border-cyan-500/30',
                ...
                title: isSelected ? 'text-white' : 'text-gray-400 group-hover:text-white',
                subtitle: isSelected ? 'text-cyan-500/80' : 'text-gray-600 group-hover:text-cyan-500/80',
                arrow: isSelected ? 'text-cyan-400 translate-x-1' : 'text-gray-600 group-hover:text-cyan-400 group-hover:translate-x-1',
                // Internal theme
                text: 'text-cyan-400',
                line: 'from-cyan-500/20 to-cyan-500/0',
                activeRing: 'border-cyan-500 shadow-[0_0_10px_rgba(6,182,212,0.5)]',
                activeDot: 'bg-cyan-500',
            };
        } else {
            return {
                border: isSelected ? 'border-purple-500/50' : 'border-white/10 hover:border-purple-500/30',
                ...
                title: isSelected ? 'text-white' : 'text-gray-400 group-hover:text-white',
                subtitle: isSelected ? 'text-purple-500/80' : 'text-gray-600 group-hover:text-purple-500/80',
                arrow: isSelected ? 'text-purple-400 translate-x-1' : 'text-gray-600 group-hover:text-purple-400 group-hover:translate-x-1',
                // Internal theme
                text: 'text-purple-400',
                line: 'from-purple-500/20 to-purple-500/0',
                activeRing: 'border-purple-500 shadow-[0_0_10px_rgba(168,85,247,0.5)]',
    ...
    return (
        <section ref={sectionRef} className="relative w-full h-full bg-black overflow-hidden flex flex-col justify-center">
            ...
            <div className="max-w-6xl mx-auto relative z-10 flex flex-col h-full w-full py-6">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-6 px-4 sm:px-6 shrink-0 gap-6 w-full">
                    ...
                    >
                        <h1 
                            className="text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-light tracking-[0.1em] leading-none text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-400 drop-shadow-2xl"
                            style={{ fontFamily: "var(--font-clash)" }}
                        >
                            PLAYBOOK
                        </h1>
                        <div className="mt-2 flex items-center gap-4 text-[9px] sm:text-[10px] font-mono tracking-[0.3em] uppercase text-gray-500">
                        ...
                        {playbooks.map((pb) => {
                            ...
                            return (
                                <m.button
                                    ...
                                    whileHover={{ y: -2 }}
                                    whileTap={{ scale: 0.98 }}
                                    className={`group relative w-36 md:w-48 h-12 overflow-hidden bg-white/[0.02] border ${classes.border} rounded-none transition-all duration-500 flex items-center px-3`}
                                >
                    ...
                    >
                        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8 relative z-10 w-full h-full pt-2">
                            ...
                            <div className="w-full lg:w-1/3 relative flex flex-col justify-between shrink-0">
                                <div>
                                    <h3 className="text-xs font-mono tracking-widest uppercase text-gray-500 mb-4 pb-2 border-b border-white/10">Execution Sequence</h3>
                                            ...
                                            {(selectedPlaybook.steps || []).map((step, i) => (
                                                ...
                                                >
                                                    <div className="relative shrink-0">
                                                        <div className={`w-5 h-5 flex items-center justify-center border transition-all duration-300 relative bg-black z-10 rounded-none ${activeStep === i ? theme.activeRing : 'border-white/10 group-hover:border-white/30'}`}>
                                                            <div className={`w-1.5 h-1.5 transition-all duration-300 rounded-none ${activeStep === i ? theme.activeDot : 'bg-transparent group-hover:bg-white/20'}`}></div>
                                                        </div>
                                                    </div>

                                                    <div className="flex-1">
                                                        <div className={`text-[8px] font-mono tracking-[0.2em] transition-colors duration-300 uppercase ${activeStep === i ? theme.text : 'text-gray-600 group-hover:text-gray-400'}`}>
                                                            Phase 0{i + 1}
                                                        </div>
                                                        <div className={`text-xs font-light transition-colors duration-300 tracking-wide mt-0.5 ${activeStep === i ? 'text-white drop-shadow-md' : 'text-gray-400 group-hover:text-gray-200'}`}>
                                                            {step.title}
                                                        </div>
                                                    </div>
                                                </button>
                                ...
                                <div className="mt-4 rounded-none border border-red-500/20 bg-white/[0.01] p-4 relative overflow-hidden flex flex-col gap-1.5 group hover:border-red-500/40 transition-all duration-500">
                                    ...
                                    <div className="text-xs sm:text-sm font-light text-white group-hover:text-red-100 transition-colors tracking-tight leading-tight">The Inevitable Outcome</div>
                                    <p className="text-gray-500 text-[10px] font-mono leading-snug mb-1 uppercase tracking-wider">Deceptive vectors lead to instant capital extraction.</p>
                                    
                                    <div className="mt-2 pt-2 border-t border-white/10 flex justify-between items-end relative z-10">
                                        <div>
                                            <div className="text-[8px] text-gray-500 font-mono uppercase tracking-widest mb-0.5">Est. Capital Loss</div>
                                            <div className="text-xl font-light text-white font-mono tracking-tighter leading-none">$12.7M</div>
                                        </div>
                                ...
                                <div className="w-full h-full relative flex-1 min-h-0">
                                    <AnimatePresence mode="wait">
                                        <m.div
                                            ...
                                            className="h-full flex flex-col justify-start bg-white/[0.02] border border-white/10 rounded-none p-5 lg:p-6 relative overflow-hidden"
                                        >
                                            <div className="absolute top-0 left-0 w-full h-full bg-gradient-to-br from-white/[0.01] to-transparent pointer-events-none"></div>

                                            <div className="flex items-center justify-between mb-4 shrink-0">
                                                <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-none border border-white/10 ${theme.text} text-[9px] font-mono uppercase tracking-widest bg-black/50`}>
                                                    Process: {selectedPlaybook.steps[activeStep].type}
                                                </div>
                                            </div>

                                            <h3 className="text-lg sm:text-xl font-light text-white mb-2 leading-tight tracking-wide shrink-0">
                                                {selectedPlaybook.steps[activeStep].title}
                                            </h3>

                                            <p className="text-gray-400 text-xs sm:text-sm font-light leading-relaxed mb-6 shrink-0">
                                                {selectedPlaybook.steps[activeStep].description}
                                            </p>

                                            {/* Simulated Terminal Readout (Sharp Minimal) */}
                                            <div className="w-full bg-black/80 border border-white/10 rounded-none p-5 font-mono text-[10px] sm:text-xs text-gray-500 overflow-hidden relative flex-1 min-h-0 flex flex-col">
                                                ...
                                                <div className="flex items-center gap-2 opacity-50 mb-3 border-b border-white/10 pb-2 shrink-0">
                                                    ...
                                                    <span className="text-[8px] uppercase tracking-widest ml-2">Terminal_Access.exe</span>
                                                </div>
                                                <div className="overflow-y-auto overflow-x-hidden flex-1 scrollbar-hide">
                                                    <pre className="whitespace-pre-wrap pl-2 leading-relaxed font-light text-gray-400">
                                                        {terminalOutputs[selected][activeStep].split('\n').map((line, idx) => (
                                                            <div key={idx} className="flex gap-3 mb-1">
                                                                <span className="text-gray-700 opacity-50 select-none">~%</span>
