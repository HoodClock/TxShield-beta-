      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-3 tracking-tight">
            TxShield <span className="text-gray-500">Core</span>
          </h2>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                         ...
                         <motion.div 
                           className={`w-16 h-16 rounded-xl flex items-center justify-center transition-all duration-300 relative overflow-hidden ${
