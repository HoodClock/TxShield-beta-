...
export default function Recommendations({
  ...
  return (
    <motion.div
      ...
      className="bg-gradient-to-br from-gray-950 via-gray-900 to-gray-950 p-8 rounded-3xl shadow-[0_0_30px_#00000066] border border-gray-800 text-white max-w-4xl mx-auto relative overflow-hidden"
    >
      ...
      {isLoading && (
        <motion.div 
          ...
          animate={{ opacity: 1 }}
          exit={{ opacity: 0 }}
          className="absolute inset-0 bg-gray-950/80 backdrop-blur-sm z-20 flex flex-col items-center justify-center"
        >
