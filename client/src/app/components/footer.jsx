        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Advanced transaction simulation and security analysis for the
              decentralized world.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a
                href="https://x.com/txshield_"
                target="_blank"
                rel="noopener noreferrer"
                className="p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-400/30 text-gray-400 hover:text-blue-400 transition-all duration-300 hover:-translate-y-1"
              >
                <FaTwitter className="text-lg" />
              </a>
              <a
                href="https://t.me/+-Jh9qvc-GHA1ZDFk"
                className="p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-blue-600/30 text-gray-400 hover:text-blue-600 transition-all duration-300 hover:-translate-y-1"
              >
                <FaTelegram className="text-lg" />
              </a>
              <a
                href="https://discord.gg/BGp7M2MXga"
                className="p-3 rounded-xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-indigo-400/30 text-gray-400 hover:text-indigo-400 transition-all duration-300 hover:-translate-y-1"
              >
