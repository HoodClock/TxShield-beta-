    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-stretch">
        ...
        <div className="lg:col-span-6 relative group">
          ...
          <div className="relative h-full p-8 rounded-3xl bg-[#0a0a0a]/40 backdrop-blur-3xl border border-white/10 flex flex-col justify-center overflow-hidden">
            ...
            <div className="relative z-10 flex items-center gap-6">
              ...
              <div className="flex-1">
                ...
                <h2 className="text-3xl sm:text-4xl font-clash font-bold tracking-tight text-white mb-1 uppercase">
                  {executionSuccess ? "SAFE PASSAGE" : "CRITICAL ALERT"}
                </h2>
                <p className="font-mono text-[11px] text-gray-400 leading-tight uppercase opacity-60">
                  {executionMessage}
                </p>
              </div>
            </div>
        ...
        <div className="lg:col-span-6 grid grid-cols-2 gap-6">
          ...
          {/* Network Load / Gas */}
          <div className="relative group p-6 rounded-3xl bg-[#0a0a0a]/40 backdrop-blur-3xl border border-white/10 flex flex-col justify-between overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-[9px] uppercase tracking-widest text-gray-500 font-bold">Network Telemetry</span>
            </div>
            <div>
              <div className="flex justify-between items-end mb-2">
                <span className="font-mono text-[10px] text-gray-400 uppercase">GAS_USAGE</span>
                <span className="font-mono text-xl font-bold text-white">{gasPercent}%</span>
              </div>
          ...
          <div className="relative group p-6 rounded-3xl bg-[#0a0a0a]/40 backdrop-blur-3xl border border-white/10 flex flex-col justify-between overflow-hidden">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="font-mono text-[9px] uppercase tracking-widest text-gray-500 font-bold">Safety Integrity</span>
            </div>
            <div>
              <div className="flex justify-between items-end mb-2">
                <span className="font-mono text-[10px] text-gray-400 uppercase">HEURISTIC_PASS</span>
                <span className="font-mono text-xl font-bold text-white">{ratioText}</span>
              </div>
              <div className="h-1.5 w-full bg-white/5 rounded-full overflow-hidden border border-white/5">
                <m.div 
                  initial={{ width: 0 }}
